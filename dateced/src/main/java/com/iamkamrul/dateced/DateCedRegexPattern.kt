...
private val patterns = listOf(
    ...
    Pair(first = """^\d{4}-\d{2}-\d{2} \d{2}:\d{2}:\d{2} \d{2}$""".toRegex(), second = "yyyy-MM-dd HH:mm:ss aa"),
    Pair(first = """^\d{4}-\d{2}-\d{2} \d{2}:\d{2} \d{2}$""".toRegex(), second = "yyyy-MM-dd HH:mm aa"),
    ...
    Pair(first = """^\d{2}-\d{2}-\d{4} \d{2}:\d{2}:\d{2} \d{2}$""".toRegex(), second = "dd-MM-yyyy HH:mm:ss aa"),
    Pair(first = """^\d{2}-\d{2}-\d{4} \d{2}:\d{2} \d{2}$""".toRegex(), second = "dd-MM-yyyy HH:mm aa"),

    Pair(first = """^\d{2}-\d{3}-\d{4}$""".toRegex(), second = "dd MMM yyyy"),
    Pair(first = """^\d{2}-\d{3}-\d{4} \d{2}:\d{2}:\d{2} \d{2}$""".toRegex(), second = "dd MMM yyyy hh:mm:ss aa"),
    Pair(first = """^\d{2}-\d{3}-\d{4} \d{2}:\d{2} \d{2}$""".toRegex(), second = "dd MMM yyyy hh:mm aa"),

    Pair(first = """^\d{2}-\d{3}-\d{4} \d{2}:\d{2}:\d{2}$""".toRegex(), second = "dd MMM yyyy HH:mm:ss"),
    Pair(first = """^\d{2}-\d{3}-\d{4} \d{2}:\d{2}$""".toRegex(), second = "dd MMM yyyy HH:mm"),


    Pair(first = """^\d{2}:\d{2}:\d{2}$""".toRegex(), second = "HH:mm:ss"),
    Pair(first = """^\d{2}:\d{2}$""".toRegex(), second = "HH:mm"),

    Pair(first = """^\d{2}:\d{2}:\d{2} \d{2}$""".toRegex(), second = "HH:mm:ss aa"),
    Pair(first = """^\d{2}:\d{2} \d{2}$""".toRegex(), second = "HH:mm aa"),
